...
f_rules = 'J:/My_reserach/Recon3D_experiment/data/recon2_result/reaction_count.csv'
recon2 = read_csv(f_rules)
recon2['reaction']=recon2['reaction'].astype(str)
...
data_path="J:/My_reserach/Recon3D_experiment/data/recon2_result/ess_reac_count.mat"
...
recon3.pop(recon3.keys()[2])
recon3.columns = ['reaction','count3']
recon2_17=recon2[recon2['count']==17]
recon3_17=recon3[recon3['count3']==17]

data=pd.merge(recon2,recon3,on='reaction')
#data_splite=data[(data['count']>=5) & (data['count3']>=5) | (data['count']==17) | (data['count3']==17)]
data_splite=data[(data['count']>=16) | (data['count3']>=16)]

datapath1 ='J:/My_reserach/Recon3D_experiment/data/recon2_result//reac23count.csv'
