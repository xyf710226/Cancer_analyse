...
flag=1 #flag=1时输出反应表达式，flag=0时输出基因rules
data_path="J:/My_reserach/Recon3D_experiment/data/Result/mat_data/Trans_tabulate_info.mat"
#Method 1
...
if flag:
    ...
    datapath1 = r'J:\My_reserach\Recon3D_experiment\data\Result\5.1-Trans_info.xls'
else:
    data=pd.merge(Rxns_count,rnxs_info,on='m_reaction')
    datapath1 = r'J:\My_reserach\Recon3D_experiment\data\Result\5.2-Trans_info.xls'
