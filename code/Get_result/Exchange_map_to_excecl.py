...
data_path="J:/My_reserach/Recon3D_experiment/data/Result/mat_data/Exchange_tabulate_info.mat"
#Method 1

data = scio.loadmat(data_path)
data=data['result']#取出字典里的label
...
if flag:
    ...
    datapath1 = r'J:\My_reserach\Recon3D_experiment\data\Result\6.1-Exchange_info.xls'
else:
    data=pd.merge(Rxns_count,rnxs_info,on='m_reaction')
    datapath1 = r'J:\My_reserach\Recon3D_experiment\data\Result\6.2-Exchange_info.xls'
